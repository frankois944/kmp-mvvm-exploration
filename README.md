...
> [!IMPORTANT]  
> This project is not a guide nor a guideline, juste direction about using KMP with iOS.
> 
> Take the way you want, it's more than a proof of concept than a real project.
